...
Port of client/src/data/lagosStops.ts
All stops are plain dicts with keys: name, latitude, longitude, type, corridor, lineIndex, corridorId
"""

# ─────────────────────────────────────────────────────────────────────────────
# BRT — Ikorodu ↔ TBS/CMS (Primero TSL, 22 km spine)
# ─────────────────────────────────────────────────────────────────────────────

BRT_STOPS = [
    # Ikorodu ↔ TBS corridor
    ...
    # Abule-Egba ↔ Oshodi extension (LAMATA, 2024)
...
BRT_IKORODU_STOPS   = [s for s in BRT_STOPS if s['corridorId'] == 'ikorodu_tbs']
BRT_ABULE_EGBA_STOPS = [s for s in BRT_STOPS if s['corridorId'] == 'abule_egba']
...
# Pairs of directly-connected ferry terminals
FERRY_ROUTES = [
...
# ─────────────────────────────────────────────────────────────────────────────
# Combined pool — used for nearest-stop search
# ─────────────────────────────────────────────────────────────────────────────

ALL_STOPS = BRT_STOPS + BLUE_LINE_STOPS + RED_LINE_STOPS + FERRY_TERMINALS + DANFO_HUBS
